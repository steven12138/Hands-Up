...
var SVGResource = /*@__PURE__*/(function (BaseImageResource) {
    ...
    SVGResource.prototype._loadString = function _loadString (svgString)
    {
        ...
        tempImage.onload = function () {
            ...
            this$1._width = Math.round(svgWidth * this$1.scale);
            this$1._height = Math.round(svgHeight * this$1.scale);

            // Create a canvas element
            var canvas = this$1.source;

            canvas.width = this$1._width;
            canvas.height = this$1._height;
            canvas._pixiId = "canvas_" + (utils.uid());

            // Draw the Svg to the canvas
            canvas
                .getContext('2d')
                .drawImage(tempImage, 0, 0, svgWidth, svgHeight, 0, 0, this$1.width, this$1.height);
...
function mapWebGLBlendModesToPixi(gl, array)
{
    ...
    array[constants.BLEND_MODES.ADD_NPM] = [gl.SRC_ALPHA, gl.DST_ALPHA, gl.ONE, gl.ONE_MINUS_SRC_ALPHA];
